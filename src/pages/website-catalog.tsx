        ...
        <StagesOfWorkBlock
          ...
          data={[
            ...
            },
            {
              ...
              text: "Разрабатываем структуру. Создаем <a href='/design' class='text-blue_main'>дизайн веб сайта</a>. Верстаем макет ресурса. Проводим его предварительное тестирование.",
              circles: 3,
            },
            {
              title: "Заполнение",
            ...
            <>
              <ul>
                {[
                  ...
                  " Базовая <a href='/seo' class='text-blue_main'>оптимизация под требованиями поисковиков</a> Google и Яндекс",
        ...
        <ChooseTheRightOneBlock
          ...
          text1={
            <p className="text-[22px] mb-[20px] font-bold">
              <a href='/' className='no-underline text-blue_main'>Разработка сайтов</a> каталогов - одно из основных направлений

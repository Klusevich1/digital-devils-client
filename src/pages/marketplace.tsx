              ...
              <div className={`flex md:flex-row flex-col justify-between`}>
                <div className="lg:block flex flex-col items-center lg:max-w-[638px] text-[18px]  lg:md:w-1/2">
                  ...
                  <p className="text-[16x] xl:text-[18px]">
                    ...
                    и <a href="/design" className="text-blue_main">уникального дизайна</a>, предоставляем клиентам инновационные
                    и эффективные решения в области программирования,
                    администрирования, настройки контекстной рекламы,
                    <a href="/seo" className="text-blue_main">SEO-продвижения</a>.
                  </p>
                  <a
                    href="/application"
                    rel="nofollow"
          ...
          text={
            <>
              ...
              <p className={"font-medium text-[20px] "}>
                Реализуем <a href='https://digitaldevils.by/' className='no-underline text-blue_main'>интернет-проекты под ключ</a> любой сложности. Создаем
                маркетплейсы в соответствии с актуальными белорусскими и
                международными стандартами качества. Используем современные
                фреймворки и популярные CMS. Четко соблюдаем сроки.
                Предоставляем гарантийную поддержку после запуска проекта.
              </p>
            </>
          }
          smallText=""

          ...
          paragraphs={[
            {
              ...
              text: "Разработка логотипа, цветов, шрифтов и правил их использования. Учитываем специфику ниши и цели бизнеса.",
            },
            {
                ...
                <div className="lg:max-w-[640px] flex flex-col">
                  <div className="flex">
                    ...
                    <p className="text-[18px] mb-[10px] font-medium  lg:max-w-[640px]">
                      Разработка фирменного стиля для сайта — это сложный

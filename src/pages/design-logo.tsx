  ...
  return (
    <>
      <SEO
        ...
        description="Создаём логотипы, которые отражают идею бренда, выделяют на фоне конкурентов и формируют доверие с первого взгляда. Уникальный визуальный образ, который легко масштабируется и работает на узнаваемость компании."

        ...
        <StandardMarginsLayout
          ...
          children={
            <div className="flex flex-col">
              <h2 className="text-[32px] mb-[30px] md:text-[42px] lg:text-[60px] font-bold lg:leading-[75px]">
              ...
              <div className="flex flex-col md:flex-row items-start justify-between">
                <div className="text-[22px] font-bold max-w-[640px] md:mr-[20px]">
                  ...
                  продвигаем проекты любой сложности — от{" "}
                  <a href="/seo-store" className="text-blue_main">
                    интернет-магазинов
                  </a>{" "}
                  до корпоративных ресурсов. Наши стратегии учитывают специфику
              ...
              <div className="flex flex-col xl:flex-row items-start justify-between mt-[50px] md:mt-[60px]">
                ...
                <div className="text-[18px] font-medium mt-[30px] xl:mt-0 xl:max-w-[640px]">
                  ...
                  <p className="text-[18px] font-medium mt-[20px]">
                    ...
                    алгоритмы, но наши методы всегда на шаг впереди.{" "}
                    <a href="/seo" className="text-blue_main">
                      Продвижение сайта
                    </a>{" "}
                    — это не разовая работа, а процесс, который приносит прибыль
                    для бизнеса годами.
                  </p>
                </div>
              </div>

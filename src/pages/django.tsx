...
const data: DataItem[] = [
    {
        ...
        description: (
            <p className="text-[18px] ">
                Да, платформа станет оптимальным вариантом для запуска самых разных приложений и сайтов, в том числе сложных порталов, взаимодействующих с объемными базами данных.
            </p>
        ),
    },
    {
        ...
        description: (
            <p className="text-[18px] ">
                Полная стоимость рассчитывается индивидуально с учетом множества факторов. Для предварительного расчета цены обратитесь к нашим менеджерам.
            </p>
        ),
    },
    {
        ...
        description: (
            <p className="text-[18px] ">
                Да. Наши специалисты всегда на связи - вы можете звонить или писать им для получения ответов на волнующие вопросы. Кроме того, мы согласуем с заказчиком результаты каждого этапа разработки для оперативного внесения корректировок, если в этом возникнет необходимость.
            </p>
        ),
    },
];
        ...
        <>
            ...
            <BasicLayout>
                ...
                <TechnologiesTitleBlock
                    title={<>Разработка <br/> сайта на Django</>}
                    ...
                    description={
                        <>
                            <p className="font-medium text-[18px] mb-[20px]">
                                В эпоху повсеместной цифровизации бизнеса, развертывание качественного и информативного сайта, запуск собственного мобильного приложения являются важной частью успеха белорусских компаний.
                            </p>
                            <p className="font-medium text-[18px] mb-[20px]">
                                CMS Django - это мощная и производительная платформа выгодно выделяется на фоне конкурентов, позволяет успешно реализовывать масштабируемые проекты, соответствующие высочайшим стандартам веб-разработки.
                            </p>
                        </>
                    }
                    buttonColor="#44B78B"
                ...
                <BlockWithImageAndDropDownMenu
                    ...
                    borderColor="#0C4B33"
                    data={[
                        {title: "Развитая экосистема", description: "В упрощенном виде Django можно сравнить с конструктором Lego. Своим пользователям фреймворк предлагает множество шаблонов и типовых блоков, возможность интеграции с большим количеством приложений от сторонних разработчиков. "},
                        {title: "Понятные инструкции", description: "Детализированные пошаговые руководства, техническая документация, многочисленные примеры упрощают процесс разработки. Встроенный ORM ускоряет разработку прототипов и готовых web-приложений."},
                        {title: "Административный интерфейс", description: "Framework поставляется встроенным административным интерфейсом, что способствует сокращению сроков запуска новых сайтов с нуля, что в конечном итоге приводит к экономии ресурсов и денежных средств. "},
                    ]}
                    firstBlock={
                ...
                <WideBlockWithImage
                    ...
                    text_1="Практика показывает, что чаще всего фреймворк Джанго на Питоне используется для разработки интернет-магазинов, корпоративных и промо сайтов, лендингов, личных блогов, социальных сетей и поисковых систем."
                ...
                <ColorfulBlock
                    ...
                    text_1={<p className="text-[16px] lg:text-[18px]">При создании сайта под ключ, мы нацелены на его успех с самых первых этапов разработки. Для этого реализуем согласованные с заказчиком планы и концепции со 100% отдачей. </p>}
                    text_2={<p className="text-[16px] lg:text-[18px]">Нам отлично известно, что успешный веб-ресурс - это не только про уникальный дизайн и программирование, но и про маркетинг, удобство для пользователей, понимание логики бизнеса, оптимизация всех компонентов площадки под требования поисковых машин. </p>}

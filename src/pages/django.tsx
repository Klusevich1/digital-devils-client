        ...
        <>
            ...
            <BasicLayout>
                ...
                <ColorfulBlock
                    ...
                    text_1={<p className="text-[16px] lg:text-[18px]">При <a href='https://digitaldevils.by/' className='no-underline text-blue_main'>создании сайта под ключ</a>, мы нацелены на его успех с самых первых этапов разработки. Для этого реализуем согласованные с заказчиком планы и концепции со 100% отдачей. </p>}

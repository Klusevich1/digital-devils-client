        ...
        <BlockWithImageAndDropDownMenu
          ...
          data={[
            ...
            },
            {
              ...
              description: [
                "Детализированные пошаговые руководства, техническая документация, многочисленные примеры упрощают процесс разработки. Встроенный ORM ускоряет разработку прототипов и готовых web-приложений.",
              ],
            },
            {

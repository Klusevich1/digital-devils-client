          ...
          paragraphs={[
            {
              ...
              text: "Создаем логотипы, цветовые палитры и гайдлайны, которые отражают характер вашего бизнеса. Каждый элемент продуман до мелочей: от шрифтов до паттернов. Это основа, на которой строится весь визуальный образ компании.",
            },
            {
            ...
            <div className="flex flex-col">
              ...
              <div className="border-t-[1px] border-black  pt-[30px]">
                ...
                <p className="text-[18px] lg:text-[22px] mt-[10px] lg:mt-[20px] font-medium max-w-[753px]">
                  Также учитывается срочность и объем работ: комплексный
                  бренд-бук будет стоить дороже отдельного баннера. Мы всегда
                  предлагаем несколько вариантов сотрудничества — от разовых
                  задач до полного сопровождения. 
                </p>
              </div>
            </div>
          }

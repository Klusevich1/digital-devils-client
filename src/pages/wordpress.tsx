...
const data: DataItem[] = [
  {
    ...
    description: (
      <p className="text-[18px] ">
        Да, для управления сайтом на WordPress не нужны какие-то особые знания и
        навыки программирования. Добавление или удаление контента со страниц
        производится в интуитивно понятном редакторе.
      </p>
    ),
  },
  {
    ...
    description: (
      <p className="text-[18px] ">
        SMC платформа подходит для реализации практически любых проектов: от
        простейших визиток и лендингов до сложных корпоративных порталов и
        интернет-магазинов.
      </p>
    ),
  },
  {
    ...
    description: (
      <p className="text-[18px] ">
        Для по завершению проекта, мы проводим обучение сотрудников заказчика,
        предоставляем услуги консультативной и технической поддержки бизнеса в
        Минске.
      </p>
    ),
  },
    ...
    <>
      ...
      <BasicLayout>
        ...
        <TechnologiesTitleBlock
          title={
            <>
              Разработка <br /> сайта на Wordpress
            </>
          }
        ...
        <HalfImageBlock
          ...
          description={
            <p className="font-medium text-[18px] mb-[20px]">
              ...
              ценам в Минске. Стоимость разработки продающих и информационных
              сайтов на движке WordPress рассчитывается индивидуально с учетом
              масштабов предстоящих работ, необходимого функционала, дизайна.
              Оставьте заявку на бесплатную консультацию для старта.
            </p>
          }
          buttonColor="#345CFF"
              ...
              <div className="flex flex-col flex-wrap md:flex-row justify-between gap-[20px]">
                {[
                  ...
                  <div className="flex items-start lg:max-w-[413px]" key={idx}>
                    <Image
                      src={"/resources/Vector_wordpress.svg"}
                      alt={"+"}
                      width={17}
                      height={15}
                    />
                    <p
                      className="text-[18px] lg:text-[22px] ms-[10px] font-bold lg:max-w-[640px]"
        ...
        <BlockWithImageAndDropDownMenu
          ...
          data={[
            {
              title: "Учитываем все детали",
              description: [
                "Прежде чем приступить к разработке, мы анализируем целевую аудиторию, исследуем бизнес заказчика, оцениваем конкурентов, для подбора наиболее эффективных технологий, шаблонов, дизайна.",
              ],
            },
            {
              title: "Ориентированы на результат",
              description: [
                "Для нас важно качество, а не количество. Стараемся сосредоточиться на реализации каждого проекта, уделить максимум внимания планированию структуры и страниц будущем веб-ресурса.",
              ],
            },
            {
              title: "Всегда на связи и не оставляем без поддержки",
              description: [
                "Оперативно реагируем на обращения клиентов, предоставляем консультацию и гарантийную поддержку в течение нескольких месяцев после размещения сайта на хостинге и его запуска. Добавляем плагины, выполняем интеграции.",
              ],
            },
            {
            ...
            {
              title: "Выполняем заказы под ключ",
              description: [
                "Команды Digital Devils - это высококлассные специалисты, которым можно заказать практически любые <a href='https://digitaldevils.by/' class='no-underline text-blue_main'>услуги по разработке и запуску сайтов</a> на WordPress, программированию, интернет-маркетингу и SEO-продвижению.",
              ],
            },
          ]}
          firstBlock={
        ...
        <ColorfulBlock
          ...
          description={
            <p>
              Мы нацелены на долгосрочное и взаимовыгодное сотрудничества,
              поэтому работаем на результат и всегда добиваемся успеха.
              Выполняем создание одностраничных и многостраничных сайтов на
              WordPress: от составления уникальных авторских макетов и внедрения
              кастомных программных кодов до адаптивной верстки, размещения
              текстового, графического, видео контента на страницах и в разделах
              ресурса.
            </p>
          }
              ...
              >
                ...
                <div className="lg:max-w-[640px]">
                  ...
                  <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                    Не бросаем клиентов на произвол судьбы после размещения
                    сайта на хостинге.
                  </p>
                  <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                    Перед публикацией ресурса тщательно проверяем его
                    работоспособность, при необходимости выполняем
                    дополнительные настройки, передаем заказчику все доступны к
                    системе и видео инструкцию по работе с сайтом. В течение
                    нескольких месяцев остаемся на связи и предоставляем

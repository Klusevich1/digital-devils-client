        ...
        <>
            ...
            <BasicLayout>
                ...
                <HalfImageBlock
                    ...
                    description={
                        <p className="font-medium text-[18px] mb-[20px]">
                            Специалисты Digital Devils разрабатывают корпоративные сайты, интернет-магазины, личные блоги и портфолио на одном из самых популярных PHP-framework в Беларуси и мире. Laravel часто называют “фреймворком для ремесленников”. Он открывает перед программистами и дизайнерами абсолютную свободу творчества, позволяет воплощать в жизнь любые идеи.
                        </p>
                    }
                    buttonColor="#FF2D20"
                ...
                <HalfImageText
                    ...
                    description={
                        <>
                            ...
                            <p className="font-medium text-[18px] mb-[10px]">
                                Создаем сайты на Laravel с нуля и под ключ: от обсуждения возможных идей и составления стратегии до переноса ресурса на хостинг. С помощью современных технологий и собственных наработок совершенствуем уже существующие проекты, предоставляем услуги технической поддержки.
                            </p>
                        </>
                    }
                />
                <BlockApproach
                    ...
                    leftBlock_p2="В нашей компании действует честная и прозрачная ценовая политика, основанная на актуальных тенденциях рынка. Осуществляем разработку под любые запросы. Интернет-магазин, корпоративный портал, информационный ресурс или веб-приложение — в Ларавел есть инструменты под эти задачи и многие другие задачи."
                    leftBlock_p3=""

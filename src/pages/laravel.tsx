...
const data: DataItem[] = [
    {
        ...
        description: (
            <p className="text-[18px] ">
                Востребованный среди программистов и разработчиков фреймворк используется для реализации нестандартных ресурсов любого формата с уникальной структурой, сложными правилами взаимодействия и модулями, создания серверной части веб-приложений.
            </p>
        ),
    },
    {
        ...
        description: (
            <p className="text-[18px] ">
                Время разработки зависит от разрабатываемого проекта, его сложности, функционала, особенностей дизайна и пожеланий. В среднем речь может идти о 2-6 месяцев.
            </p>
        ),
    },
    {
        ...
        description: (
            <p className="text-[18px] ">
                Да, но все типовые функции придется реализовывать с нуля. По этой причине, фреймворк задействуют для реализации непростых и долгосрочных проектов, рассчитанных на дальнейшее масштабирование и модернизацию.
            </p>
        ),
    },
];
        ...
        <>
            ...
            <BasicLayout>
                ...
                <TechnologiesTitleBlock
                    title={<>Разработка <br/> сайта на Laravel</>}
                ...
                <HalfImageBlock
                    ...
                    description={
                        <p className="font-medium text-[18px] mb-[20px]">
                            Специалисты Digital Devils разрабатывают <a href='https://digitaldevils.by/corporate-website' className='no-underline text-blue_main'>корпоративные сайты</a>, <a href='https://digitaldevils.by/online-store' className='no-underline text-blue_main'>интернет-магазины</a>, личные блоги и портфолио на одном из самых популярных PHP-framework в Беларуси и мире. Laravel часто называют “фреймворком для ремесленников”. Он открывает перед программистами и дизайнерами абсолютную свободу творчества, позволяет воплощать в жизнь любые идеи.
                        </p>
                    }
                    buttonColor="#FF2D20"
                ...
                <BlockWithImageAndDropDownMenu
                    ...
                    borderColor="#FF2D20"
                    data={[
                        {title: "Стандартные системные требования", description: "Это значит, что для запуска сайтов на Ларавел подходят почти все хостинги, представленные на рынке Минска и РБ."},
                        {title: "Простота в управлении и масштабируемость", description: "Поможем настроить административную панель под вас и вашу команду. Управлять сайтами на Laravel просто и комфортно. В будущем для расширения системы можно подключить новые функции и опции. "},
                        {title: "Гибкий и широкий функционал", description: "Встроенные инструменты и возможности системы позволяют выстраивать структуру и дизайн под конкретные запросы заказчика. Границ практически нет!"},
                    ]}
                    firstBlock={
                        <div className="relative h-fit lg:max-w-[753px] block lg:min-w-[422px] lg:me-[30px]">
                            ...
                            <div className="w-full flex justify-end absolute bottom-[15px] right-5 lg:right-3">
                                ...
                                >
                                    <span className="md:text-[22px] text-[16px] lg:text-[24px]">Сайт</span>
                                </a>
                            </div>
                        </div>
                    }
                    ...
                    description={
                        <>
                            <p className="font-bold text-[22px] mb-[10px]">
                                Команда Digital Devils осознанно и ответственно подходит к работе с каждым клиентом.
                            </p>
                            <p className="font-medium text-[18px] mb-[10px]">
                                Мы кастомизируем процессы под проекты, тратим попусту время и ресурсы. Ежедневно к нам обращаются заказчика из Минска и других городов Беларуси с разными запросами и все они получают оптимальные именно для них решения. Не используем шаблоны.
                            </p>
                            <p className="font-medium text-[18px] mb-[10px]">
                            <a href='https://digitaldevils.by/' className='no-underline text-blue_main'>Создаем сайты</a> на Laravel с нуля и под ключ: от обсуждения возможных идей и составления стратегии до переноса ресурса на хостинг. С помощью современных технологий и собственных наработок совершенствуем уже существующие проекты, предоставляем услуги технической поддержки.
                            </p>
                        </>
                    }
                />
                ...
                <ColorfulBlock
                    ...
                    text_1={<p className="font-medium text-[18px]">Готовое к публикации в сети решение, способное работать на пользу вашему бизнесу</p>}
                    text_2={<p className="font-medium text-[18px]">Эффективную настройку ресурса под SEO продвижение в поисковых системах</p>}

...
const data: DataItem[] = [
  {
    ...
    description: (
      <p className="text-[18px] ">
        Да, перед началом работ мы подписываем официальный договор, выставляем
        счет и ожидаем оплату. По завершении проекта передаем сайт клиенту и
  ...
  },
  {
    ...
    description: (
      <p className="text-[18px] ">
        Конкретные сроки зависят от проекта и ряда других факторов: объема
        предстоящих работ, формата и структуры веб-ресурса, скорости получения
        обратной связи от заказчика и т.д. В среднем мы создаем визитки,
        лендинги и каталоги товаров на Тильда в течение 2-3 недель.
      </p>
    ),
  },
  {
    title:
      "Возьмете ли вы в разработку сайт, если заказчик находится не в Минске?",
    description: (
      <p className="text-[18px] ">
        Место нахождения клиента для нас не имеет значения. Мы работаем по всей
        страны и с любыми регионами Беларуси. Обсудить условия сотрудничества
        можно по телефону или видеосвязи.
      </p>
    ),
  },
];
    ...
    <>
      ...
      <BasicLayout>
          ...
          data={[
            {
              ...
              description:
                "На реализацию небольшого проекта у специалистов нашего агентства уходит 2-3 недели. Конкретные сроки зависят от предпочтений заказчика в дизайне и поставленных им задач. ",
            },
            {
              title: "Широкие возможности для SEO продвижения",
              description:
                "Далеко не все веб-ресурсы, собранные на конструкторах, пригодны для последующей поисковой оптимизации. В случае с Тильда этот минус отсутствует. Еще на этапе разработки мы помогаем настроить протокол HTTPS, получить сертификат SSL, заполнить метатеги, выставить редиректы, создать robots.txt.",
            },
          ]}
          firstBlock={
                ...
                <div className="bg-[#171717] xl:max-w-[528px] xl:translate-y-[16px] w-full text-white lg:p-[40px] px-[20px] py-[30px] flex flex-col rounded-[40px] xl:me-[39px]  mb-[30px]">
                  ...
                  <div className="flex space-x-3 items-center xl:justify-between mt-[25px] bg-[#242730] p-[20px]">
                    ...
                    <p className="text-[16px] lg:text-[18px] font-medium">
                      среднее количество запускаемых нами сайтов на Tilda в
                      месяц
                    </p>
                  </div>
                  <p className="text-[16px] lg:text-[18px] font-medium mt-[25px]">
                    Разработаем по вашему запросу{" "}
                    <a
                    ...
                    <a
                      ...
                      className="no-underline text-blue_main"
                    >
                      корпоративную визитку
                    </a>
                    .
                  </p>
                  <p className="text-[16px] lg:text-[18px] font-medium mt-[10px]">
                    Наши сайты быстро индексируются, имеют продуманный
                    интерфейс.
                  </p>
                </div>
                <TildaSlider
        ...
        <ColorfulBlock
          ...
          text_1={
            <div className="flex flex-col">
              ...
              <p className="text-[16px] lg:text-[18px] font-medium">
                Все процессы студии оптимизированы - прежде чем создать сайт на
                Tilda оцениваем конкурентные преимущества продукта и особенности
                бизнеса. До мелочей продумываем концепцию и прототип. Создаем
                дизайн с применением базовых блоков и авторских элементов.
              </p>
            </div>
          }
          text_2={
            <div className="flex flex-col">
              ...
              <p className="text-[16px] lg:text-[18px] font-medium">
                Готовый сайт передаем заказчику вместе с видео инструкцией,
                учетными данными для доступа к личному кабинету аккаунта. При
                необходимости наши мастера оперативно ответят на возникающие
                вопросы, помогут с подключением сторонних сервисов и
              ...
              >
                ...
                <div className="lg:max-w-[640px]">
                  ...
                  <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                    Отталкиваясь от особенностей и сферы вашего бизнеса, текущей
                    ситуации на белорусском и международном рынке, мы не просто
                    предлагаем создание сайтов на Tilda, а подбираем комплекс
                    инструментов, технологий и интеграций, которые будут
                    наиболее эффективно и качественно работать на увеличение
                    продаж через интернет.
                  </p>
                  <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                    Огромный опыт и высокая квалификация позволяют нам
                    разрабатывать проекты под ключ любой сложности. Используем в
                    работе все популярные CMS, фреймворки. По результатам нашего
                    сотрудничества вы получаете полностью работоспособный
                    веб-ресурс, на который не стыдно приглашать пользователей.
                  </p>
                </div>
              </div>
            </div>
        ...
        <BlockApproach
          ...
          rightBlockPrice="400$"
          rightBlockList={[
            "<a href='https://digitaldevils.by/' class='no-underline'>Разработка сайта под ключ</a>",
            "Правки",
          ...
          description={
            <>
              <p className="font-bold text-[22px] mb-[10px]">
                Специалисты Digital Devils знают, насколько важно присутствие в
                интернете для развития современного бизнеса
              </p>
              <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                Своим клиентам мы предлагаем комплексные и персонализированные
                решения, позволяющие превращать идеи в успешные онлайн-проекты.
                На постоянной основе внедряем новейшие методы и технологии,
                которые помогают вам быть лучше конкурентов, получать постоянный
                поток клиентов.
              </p>
              <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                Мы не работаем “на поток”. К запуску каждого сайта подходим
                индивидуально и со всей ответственностью.
              </p>
            </>
          }
        />

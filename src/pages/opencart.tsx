...
const data: DataItem[] = [
    {
        title: "Как перенести каталог товаров со старого сайта на новый, созданный на Opencart?",
        description: (
            <p className="text-[18px] ">
                Для этого Digital Devils предлагает воспользоваться услугой переноса сайта. Самостоятельно решить подобную задачу будет непросто, к тому же существует риск случайной потери всей базы
                данных.
            </p>
        ),
    },
    {
        ...
        description: (
            <p className="text-[18px] ">
                Да, у нас работают высококлассные программисты, которые могут воплотить в жизнь любые идеи.
            </p>
        ),
    },
    {
        ...
        description: (
            <p className="text-[18px] ">
                Фактически нет, CMS можно настраивать так, как удобно пользователям, верстать и программировать сайты в соответствии с ожиданиями и запросами заказчика.
            </p>
        ),
    },
];
        ...
        <>
            ...
            <BasicLayout>
                ...
                <TechnologiesTitleBlock
                    title={<>Разработка <br/> сайта на Opencart</>}
                ...
                <HalfImageText
                    ...
                    smallTitle={"OpenCart - функциональная и надежная CMS с открытым исходным кодом"}
                    ...
                    description={
                        <>
                            <p className="font-bold text-[22px] mb-[10px]">
                                Популярная платформа позволяет создавать удобные и простые в управлении сайты любого формата: их администрирование может осуществляться даже пользователями, не имеющими навыков программирования.
                            </p>
                            <p className="font-medium text-[18px] mb-[10px]">
                                Подбор модулей и блоков осуществляется под конкретные потребности бизнеса. По вашему запросу мы готовы провести интеграцию систем оплаты, внедрить поиск и фильтры, разработать индивидуальный функционал, настроить оптимизацию ресурса для его успешного продвижения в Яндекс и Google.
                            </p>
                        </>
                    }
                />
                    ...
                    description={
                        <>
                            <p className="font-medium text-[18px] mb-[20px]">
                                Ключевое преимущество CMS OpenCart - система изначально предназначена для интернет-магазинов и других проектов eCommerce.
                            </p>
                            <p className="font-medium text-[18px] mb-[20px]">
                                Разработки предоставляют доступ к мощным встроенным инструментам управления заказами, товарами, оплатой и доставкой. Сайты, разработанные на этом движке, отличаются
                                быстродействием, мгновенной обработкой запросов, загрузкой страниц, что способствует улучшению конверсии и пользовательского опыта.
                            </p>
                        </>
                    }
                    buttonColor="#3DCAF0"
                ...
                <BlockWithImageAndDropDownMenu
                    ...
                    borderColor="#000000"
                    data={[
                        {title: "Быстрый запуск", description: "Чтобы ускорить процесс создания сайтов на ОпенКарт возможно использование собственных скриптов и готовых модулей системы."},
                        {title: "Функциональная синхронизация", description: "Работу сайта можно синхронизировать со складскими и торговыми программами, платежными системами, сервисами доставки."},
                        {title: "Интуитивно понятный интерфейс", description: "У владельцев ресурса не возникнет проблем с добавлением, удалением и редактированием контента, независимо от их опыта в программировании."},
                        {title: "Свыше 100 000 позиций в каталоге", description: "OpenCart позволяет загружать в каталог интернет-магазина более 100 тыс. товарных позиций под доработок производительности."},
                    ]}
                    firstBlock={
                    ...
                    description={
                        <>
                            <p className="text-[16px] lg:text-[18px] mb-[5px]">
                                Студия Digital Devils предоставляет полный комплекс услуг в сфере web-разработки, включая подготовку эксклюзивных макетов, прототипирование, программирование,

  ...
  return (
    <>
      ...
      <BasicLayout>
            ...
            <div className={`flex flex-col gap-[30px]`}>
              <div>
                ...
                <p className="md:text-[22px] text-[20px] font-medium max-w-[866px]">
                  ...
                  <a href="/online-store" className="text-blue_main">
                    интернет-магазина
                  </a>
                  , локального сервиса и корпоративного сайта будет разным.
                  Правильно выбранная стратегия экономит бюджет и ускоряет выход
                  в топ.  
                </p>
              </div>
              <div
          ...
          description={
            <>
              <p className="font-medium text-[18px] mb-[20px]">
                Наша команда быстро и легко делает{" "}
                <a href="/mob-pwa" className="text-blue_main">
                  мобильную версию сайтов
                </a>{" "}
                так, чтобы они были максимально удобны для посетителей и
                нравились поисковым системам. Быстрота загрузки, юзабилити и
                адаптивный дизайн – вот на что мы делаем упор.
              </p>
            </>
          }
          buttonColor="#345CFF"
        ...
        />
        <WideBlockWithImage
          title="Почему SEO необходимо каждому бизнесу"
          text_1="В эпоху цифровизации бизнеса наличие сайта — это лишь первый шаг."
          text_2="Без грамотного продвижения вас не найдут клиенты. SEO (Search Engine Optimization) — это самый эффективный способ привлекать целевой трафик из систем бесплатно."
        />
        <StandardMarginsLayout
        ...
        />
        <DifferentTasksBlock
          bigTitle="Ключевые аспекты SEO"
          smallText="Грамотное SEO продвижение — это не просто «подгонка» под алгоритмы, а создание качественного сайта, который будет полезен посетителям и удобен для поисковых систем."
          paragraphs={[
            {
              title: "Техническая часть",
              text: "Cкорость работы, адаптация под мобильные устройства, безопасность данных.",
            },
            {
              title: "Контент",
              text: "Полезность информации, ее соответствие поисковым запросам",
            },
            {
              title: "Поведение пользователей",
              text: "Время, проведенное на сайте, количество просмотренных страниц.",
            },
            {
              title: "Репутация",
              text: "Упоминания на авторитетных сайтах.",
            },
          ]}
          isDark={false}
        ...
        <StandardMarginsLayout
          ...
          children={
            <>
              <div>
                <h2 className="text-[32px] md:text-[42px] lg:text-[60px] font-bold mb-[30px]">
                  Услуги (стройка, ремонт, юристы и т.д.)
                </h2>
                <div className="flex md:flex-row flex-col md:gap-[40px] gap-[20px]">
                  <p className="md:max-w-[300px] text-[16px] font-medium">
                    Локальное SEO (оптимизация под запросы с гео-уточнениями:
                    "ремонт квартир в Минске").
                  </p>
                  <p className="max-w-[300px] text-[16px] font-medium">
                    Размещение в Google My Business и Яндекс.Справочнике (вывод
                    в "картах").
                  </p>
                  <p className="max-w-[300px] text-[16px] font-medium">
                    Контент с кейсами (фото "до/после", отзывы клиентов).
                ...
                <p className="max-w-[911px] mt-[20px] text-[22px] font-medium">
                  Часто клиенты ищут услуги с мобильных — критична скорость
                  загрузки и кнопка "Позвонить".
                </p>
              </div>
            </>
          }
          ...
          children={
            <>
              <div>
                ...
                <div className="flex md:flex-row flex-col md:gap-[40px] gap-[20px]">
                  <p className="md:max-w-[300px] text-[16px] font-medium">
                    Глубокая проработка тем при поисковой оптимизации (длинные
                    статьи 3000+ символов с экспертностью).
                  </p>
                  <p className="max-w-[300px] text-[16px] font-medium">
                    Монетизация через рекламу/партнерки (высокий трафик =
                    доход).
                ...
                <p className="max-w-[911px] mt-[20px] text-[22px] font-medium">
                  Например, сайт о здоровом питании должен отвечать не только на
                  запросы "как похудеть", но и на смежные: "рецепты ПП на
                  завтрак", "как считать калории".
                </p>
                <p className="max-w-[911px] mt-[20px] text-[22px] font-bold">
                  Выбор стратегии при продвижении зависит от типа бизнеса,
                  конкурентов и целей. Например, локальному бизнесу важны
                  геозапросы, а интернет-магазину — точные коммерческие фразы.
                </p>
              </div>
            </>
          }

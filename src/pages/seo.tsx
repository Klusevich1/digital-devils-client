            ...
            <div className={`flex flex-col gap-[30px]`}>
              <div>
                ...
                <p className="md:text-[22px] text-[20px] font-medium max-w-[866px]">
                  ...
                  <a href="/online-store" className="text-blue_main">интернет-магазина</a>, локального сервиса и корпоративного сайта
          ...
          description={
            <>
              <p className="font-medium text-[18px] mb-[20px]">
                Наша команда быстро и легко делает <a href="/mob-pwa" className="text-blue_main">мобильную версию сайтов</a> так,

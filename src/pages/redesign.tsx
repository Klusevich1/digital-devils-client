        ...
        <DifferentTasksBlock
          ...
          paragraphs={[
            ...
            },
            {
              ...
              text: "Более 60% трафика приходит со смартфонов. <a href='/mob-pwa' class='text-blue_main'>Оптимизируем дизайн для мобильных экранов</a>, ускорим загрузку и улучшим юзабилити.",
            },
          ]}
          isDark={true}
        />
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:space-x-[41px]">
              <div className="lg:max-w-[753px]">
                ...
                <p className="text-[18px] lg:text-[22px] mt-[10px] font-medium">
                  ...
                  с любыми нишами: от <a href="/online-store" className="text-blue+main">интернет-магазинов</a> до <a href="/corporate-website" className="text-blue_main">корпоративных
                  сайтов</a>.
                </p>
              </div>
                ...
                >
                  ...
                  <div>
                    <span className="text-[16px] font-medium">
                      ...
                      критически важно для <a href="/seo" className="text-blue_main">SEO</a>.
                    </span>
                  </div>
                </div>
              </div>

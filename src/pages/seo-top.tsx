    ...
    <>
      ...
      <BasicLayout>
        ...
        <HalfImageBlock
          ...
          smallTitle="Не бывает двух одинаковых бизнесов — у каждого свои цели, бюджет и сроки"
          description={
            <>
        ...
        <BlockWithListOfCurrentTechnologies
          ...
          list={[
            ...
            "Мобильная адаптация — настраиваем корректное отображение на всех устройствах",
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-[41px]">
              <div className="lg:max-w-[754px]">
                ...
                <p className="text-[18px] mt-[10px] font-medium">
                  На каждом этапе вы будете видеть динамику SEO продвижения
                  сайта. Мы предоставляем прозрачные отчеты и даем рекомендации
                  по улучшению. Наша цель — не просто выполнить работу, а помочь
        ...
        <DifferentTasksBlock
          ...
          paragraphs={[
            ...
            },
            {
              ...
              text: "Интернет-магазинам с широким ассортиментом органический трафик позволяет снизить зависимость от маркетплейсов и их комиссий. Каждая товарная категория и даже отдельные карточки товаров могут привлекать целевых посетителей через поиск.",
            },
          ]}
          isDark={false}
                ...
                <div className="flex flex-col min-w-[40%]">
                  ...
                  <div className="flex">
                    ...
                    <p className="md:text-[18px] text-[16px] mb-[10px] font-medium  lg:max-w-[640px]">
                      ...
                      процесс. Google и Яндекс ежегодно вносят сотни изменений в
                      свои алгоритмы, и успешные сайты всегда быстро под них
                      подстраиваются.
                    </p>
                  </div>
                </div>

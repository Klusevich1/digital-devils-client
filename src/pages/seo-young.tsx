          ...
          description={
            <>
              <p className="font-medium text-[18px] mb-[20px]">
                ...
                <a href="/mob-pwa" className="text-blue_main"> мобильную версию</a> с интуитивным дизайном, где все продумано для
                ...
                <div className="flex flex-col lg:block items-center">
                  <div>
                    ...
                    <p className="text-[18px] font-medium">
                      ...
                      места конкурентов при <a href="/seo" className="text-blue_main">SEO продвижении</a>, занимаем свободные
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-[20px]">
                <div className="lg:max-w-[640px]">
                  <p className="text-[16px] font-medium mb-[10px]">
                    ...
                    этапе <a href="/" className="text-blue_main">разработки сайта</a>. В этом случае мы можем влиять на
                  ...
                  <p className="text-[16px] font-medium">
                    ...
                    кредитом доверия от <a href="/seo-google" className="text-blue_main">Google</a> и <a href="/seo-yandex" className="text-blue_main">Яндекс</a>.
                  </p>
                </div>
                <div className="lg:max-w-[640px]">
                  <p className="text-[16px] font-medium mb-[10px]">

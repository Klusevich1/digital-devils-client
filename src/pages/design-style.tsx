            ...
            <div className="flex flex-col lg:flex-row lg:space-x-[41px]">
              ...
              <div className="lg:max-w-[754px]">
                ...
                <p className="text-[18px] mt-[10px] font-medium">
                  Мы создаем дизайн, который делает ваш бренд узнаваемым,
                  усиливает доверие клиентов и выделяет вас среди конкурентов.
                  Это инвестиция, которая окупается за счет роста лояльности и
                  увеличения продаж.
                </p>
              </div>
            </div>
          ...
          paragraphs={[
            {
              ...
              text: "Разрабатываем дизайн с нуля: от нейминга и логотипа до полного бренд-бука. Учитываем позиционирование, ценности и особенности целевой аудитории, чтобы создать целостный образ.",
            },
            {
              title: "Ребрендинг",

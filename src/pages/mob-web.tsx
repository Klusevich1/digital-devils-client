    ...
    <>
      ...
      <BasicLayoutDark>
            ...
            <div className="flex flex-col lg:flex-row lg:space-x-[41px]">
              ...
              <div className="lg:max-w-[754px]">
                ...
                <p className="text-[18px] mt-[20px] font-medium">
                  ...
                  <a href="/mob-ios" className="text-blue_main">
                    iOS
                  </a>
                  ,{" "}
                  <a href="/mob-android" className="text-blue_main">
                    Android
                  </a>{" "}
                  или обе, тип продукта - нативный или кросс-платформенный,
        ...
        <BlockWithImageAndDropDownMenu
          isDark={true}
          title="Процесс разработки веб-приложений включает несколько этапов:"
          borderColor="#ffffff"
          margin="md:py-[60px] py-[50px]"
          data={[
            {
              title: "Подготовка ТЗ и плана",
              description: [
                "На начальных этапах мы изучаем идею и требования заказчика, определяем целевую аудиторию, оптимальный стек технологий и архитектуру будущего приложения.",
              ],
            },
            {
              title: "Проектирование пользовательского интерфейса",
              description: [
                "Разрабатываем wireframe и прототип продукта. Создаем дизайн макет, адаптируем решение под разные устройства, согласуем концепцию с заказчиком.",
              ],
            },
            {
              title: "Разработка функционала",
              description: [
                "Команда Digital Devils готовит серверную и клиентскую части веб-приложения.",
              ],
            },
            {
              title: "Ручное и автоматизированное тестирование",
              description: [
                "Тестируем ПО на функциональность, производительность, безопасность, совместимость с разными мобильными девайсами: смартфонами, планшетами.",
              ],
            },
            {
              title: "Релиз и поддержка",
              description: [
                "Выполняем развертывание приложения на сервере. Мониторим его работоспособность, отслеживаем логи, оперативно устраняем возникающие ошибки.",
              ],
            },
          ]}
          firstBlock={
            <>
              ...
              <div className="w-full md:hidden flex">
                <Image
                  src={"/resources/mob-web3_small.png"}
                  width={340}
                  height={258}
                  className="w-full"
                  alt="Подготовка к SEO аналитике сайта: ключевые аспекты"

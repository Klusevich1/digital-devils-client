          ...
          description={
            <>
              <p className="font-medium text-[18px] mb-[10px]">
                <a href="/mob-apps" className="text-blue_main">Разработка мобильного ПО</a> выполняется с учетом уникальных
          ...
          text2={
            <ul className="flex flex-col gap-[5px]">
              {[
                ...
                " Подготовка прототипа приложения и <a href='/mob-design' class='text-blue_main'>дизайн-макета</a>",

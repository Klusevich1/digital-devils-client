  ...
  const data: DataItem[] = [
    {
      ...
      description: (
        <p className="text-[18px] ">
          Да, в будущем лендинг можно расширить: добавить разделы и новые
          функции, переработать в более сложный по структуре сайт.
        </p>
      ),
    },
    {
        ...
        <StagesOfWorkBlock
          ...
          data={[
            ...
            },
            {
              ...
              text: "Настроим аналитику, которая позволит отслеживать все заявки с сайта. Вы будете знать с точностью до процента какова конверсия продающей страницы, во сколько вам обходится каждый лид. Привяжем лендинг к CRM-системе, подключим онлайн-кассы. Проработаем первичную SEO оптимизацию под Google и Яндекс.",
              circles: 5,
            },
            {
          ...
          text={
            <div>
              <p className="text-[20px] mb-[20px] font-medium">
                ...
                задания. Вы можете заказать <a href="https://digitaldevils.by/" className="no-underline text-blue_main">создание сайта под ключ</a> или выбрать
                другой формат работы в нашем прайсе. Оставьте заявку и свои
                контактные данные в форме обратной связи. Мы обязательно

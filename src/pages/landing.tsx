...
который работает на ваш успех!"
      ...
      <BasicLayout>
        ...
        />
        <WideBlockWithImage
          title="Landing Page – эффективный инструмент для любого бизнеса"
          text_1="Landing Page поможет быстро вывести товар на рынок, познакомить потенциальных покупателей с продуктом, отстроиться от конкурентов, привлечь трафик и внимание целевой аудитории, получить контакты клиентов, с которыми в дальнейшем можно работать для увеличения объемов продаж."
          text_2="Важная цель лендинга – подтолкнуть пользователя к совершению желаемого бизнес-действия: регистрация, переход по ссылке, оформление заказа и доставки и т.д. Благодаря предельно простой и в тоже время продуманной до мелочей структуре использование сайта не вызывает вопросов и позволяет гарантировать стабильно высокую конверсию."
          bg="bg-white"
        />
        <StandardMarginsLayout
          ...
          children={
            <div className="flex flex-col">
              <h2 className="text-[32px] md:text-[42px] lg:text-[60px] font-bold mb-[30px] max-w-[1093px]">
                Работа наших дизайнеров
              </h2>
              <p className="text-[18px] mb-[30px] lg:text-[22px] font-medium  max-w-[866px]">
                Наши дизайнеры создают привлекательные и интуитивно понятные
                интерфейсы в корпоративном стиле и цвете, с фирменными
                логотипами, выверенным расположением кнопок, полей, блоков.
              </p>
              <div className="border-t-[1px] border-white pt-[30px]">
                <p className="text-[16px] mt-[10px] lg:mt-[20px] font-medium max-w-[753px]">
                  Каждое окно и раздел меню, текстовое и графическое наполнение
                  отвечают на конкретные запросы посетителей и работают на
                  решение поставленных задач.  Команда разработчиков уделяет
                  максимум внимания программированию, автоматизации и
                  интеграциям, за счет чего достигается высокая скорость
                  загрузки, низкая отказоустойчивость, адаптированность ресурса
                  под любые виды устройств. 
                </p>
              </div>
            </div>
          }
        />
        <DifferentTasksBlock
          bigTitle="Мы покажем ваши сильные стороны"
          smallText="Специалисты агентства Digital Devils готовы разработать Landing Page, который будет сочетать преимущества и сильные стороны небольших интернет-магазинов, сайтов-визиток и корпоративных сайтов-каталогов, для заказчиков из любых сфер деятельности:"
          paragraphs={[
            {
              title: "E-commerce",
              text: "Яркие лендинги нередко используются в качестве дополнительного инструмента повышения конверсии и продаж крупными онлайн-магазинами.",
            },
            {
              title: "Стартапы",
              text: "Начинающие производители и поставщики уникальных товаров выбирают лендинги для презентации собственных продуктов. В отдельных ситуациях Landing Page выполняют функцию онлайн офиса каталога с оплатой заказов на сайте.",
            },
            {
              title: "Компании B2B",
              text: "Предприятия с ограниченным ассортиментом товаров выбирают лендинги вместо полноценных корпоративных сайтов для предоставления информации о себе и своих кейсах потенциальным партнерам и клиентам.",
            },
            {
              title: "Успешные блогеры и инфлюенсеры",
              text: "Лицам, специализирующиеся на создании и продвижении контента, одностраничник помогает рекомендовать подписчикам определенные категории товаров, привлекать новую аудиторию.",
            },
          ]}
          isDark={false}
          hasLine={false}
          maxwSmallText="max-w-[754px]"
        />
        <StandardMarginsLayout
            ...
            <>
              ...
              <div className="flex flex-col lg:flex-row justify-between lg:gap-[20px]">
                <div className="lg:max-w-[640px] lg:pb-0 pb-[30px] lg:border-none border-b-[1px] border-black">
                  <p className="text-[22px] font-bold">
                    Студия Digital Devils предлагает выгодные условия
                    сотрудничества и индивидуальный подход к работе с каждым
                    клиентом.
                  </p>
                  <p className="text-[16px] font-medium mt-[10px]">
                    Наша ключевая особенность – мы стремимся создавать
                    действительно хорошие одностраничные сайты любой тематики,
                    способные трансформировать рекламный трафик в конкретные
                    цели: заявки, заказы, подписки. Предоставляем полный спектр
                    услуг. 
                  </p>
                </div>
                  ...
                  <ul className="flex flex-col gap-[10px]">
                    <li className="flex flex-row items-start gap-[10px]">
                      <span className="text-[16px] font-medium">
                        Дополнительно проводим настройку контекстной рекламы и
                        рекламных кампаний, продумываем возможности для
                        автоматизации рутинных операций, выполняем интеграцию с
                        необходимыми заказчику сервисами: электронной почтой,
                        мессенджерами, социальными сетями, платежными системами
                        и т.д.
                      </span>
                    </li>
                    <li className="flex flex-row items-start gap-[10px]">
                      <span className="text-[16px] font-medium">
                        Предоставляем техническую поддержку и помощь. Работаем
                        по договору. Всегда укладываемся в запланированные
                        бюджеты. Чтобы получить бесплатную консультацию
                        достаточно позвонить или написать нашим менеджерам.
                      </span>
                    </li>
                  </ul>
                </div>

...
const data: DataItem[] = [
    {
        title: "Существуют ли ограничения по количеству страниц, разделов, категорий и товаров при разработке интернет-магазина на Joomla?",
        description: (
    ...
    {
        title: "Что требуется от меня для оформления заказа на создание сайта на Джумла?",
        description: (
            <p className="text-[18px] ">
                Будьте готовы рассказать нам о своем видении и концепции будущем веб-ресурса. Все остальные моменты: от регистрации домена до запуска готового сайта и его настройку под СЕО-продвижения
                мы возмем на себя.
            </p>
        ),
    },
    {
        ...
        description: (
            <p className="text-[18px] ">
                Да, в течение двух месяцев после запуска сайта мы оказываем информационную и консультационную помощь по гарантии. О возможности дальнейшей поддержки и администрировании ресурса
                уточните у наших менеджеров.
            </p>
        ),
    },
];
        ...
        <>
            ...
            <BasicLayout>
                ...
                <TechnologiesTitleBlock
                    title={<>Разработка <br/> сайта на Joomla</>}
                        ...
                        <div className="flex flex-col">
                            <div className={`flex flex-col  justify-between lg:flex-row-reverse`}>
                                <div className="lg:flex w-full justify-start hidden rounded-[40px] lg:max-w-[445px] ms-[30px]">
                                    <Image src={'/resources/joomla4.png'} alt={"Разработка под ключ"} className="max-w-[371px] max-h-[371px]" width={371} height={371}/>
                                </div>
                                <div className="lg:max-w-[640px]">
                                    ...
                                    <div className="block lg:hidden mb-[30px] mx-auto rounded-[40px]">
                                        <Image src={'/resources/joomla4.png'} alt={"Разработка под ключ"} className="w-full" width={371} height={371}/>
                                    </div>
                                    <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                                        Команды специалистов Digital Devils выполнят разработку профессиональной сайтов любой сложности на Joomla - одной из самых популярных систем управления
                                        контентом в
                                        Беларуси.
                                    </p>
                                    <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                                        Воплощаем в жизнь любые дизайнерские идеи и функциональные возможности. Создаем по запросу наших клиентов блоги, <a href='https://digitaldevils.by/online-store' className='no-underline text-blue_main'>интернет-магазины</a>, <a href='https://digitaldevils.by/website-catalog' className='no-underline text-blue_main'>электронные каталоги</a>,
                                        <a href='https://digitaldevils.by/landing' className='no-underline text-blue_main'>одностраничные</a>
                                        и многостраничные <a href='https://digitaldevils.by/portal' className='no-underline text-blue_main'>корпоративные порталы</a>. Мы знаем, как сделать так, чтобы ваш сайт был привлекателен и полезен для пользователей, функционировал без сбоев и
                                        ошибок.
                                    </p>
                                </div>
                            </div>
                    ...
                    data={[
                        {
                            ...
                            description: "Joomla - это интуитивно понятная система управления контентом. Конструктор платформы позволяет быстро создавать, редактировать и публиковать контент даже без знания программирования. "
                        },
                        {
                            title: "Масштабируемость и гибкость",
                            description: "На базе CMS можно <a href='https://digitaldevils.by/' class='no-underline text-blue_main'>создавать сайты любой сложности</a>. В системе имеется множество расширений, которые позволяет масштабировать и изменять уже функционирующий\t ресурс по мере развития бизнеса. "
                        },
                        {
                            title: "Постоянное развитие",
                            description: "Движок и его расширения обновляются на постоянной основе - актуальные тенденции в дизайне и веб-разработке оперативно реализуются на Joomla. Проблемы, связанные с безопасностью оперативно устраняются. "
                        },
                    ]}
                    firstBlock={
                        <div className="relative h-fit lg:max-w-[753px] block lg:min-w-[422px] lg:me-[30px]">
                            ...
                            <div className="w-full flex justify-end absolute bottom-[15px] right-5 lg:right-3">
                                ...
                                >
                                    <span className="md:text-[22px] text-[16px] lg:text-[24px] text-white">Сайт</span>
                                </a>
                            </div>
                        </div>
                    }
                ...
                <HalfImageText
                    ...
                    widthImage={528}
                    heightImage={300}
                    smallTitle={"Разработка сайта на Joomla - комплексная задача, решение которой требует индивидуального подхода."}
                    buttonColor="#345CFF"
                    buttonText="Связаться с нами"
                    description={
                        <>
                            <p className="font-bold text-[18px] lg:text-[22px] mb-[10px]">
                                По результатам сотрудничества с Digital Devils вы получаете простой в администрировании и визуально привлекательный ресурс с набором самых необходимых функций и
                                компонентов:
                            </p>
                            <ul className="my-[20px]">
                                {[
                                    ...
                                    <li key={idx}><span className="text-custom_yellow text-[16px] lg:text-[18px] font-medium">/</span> {item}</li>
                                ))}
                            </ul>
                        </>
                    }
                ...
                <ColorfulBlock
                    ...
                    text_1={<p className="text-[16px] lg:text-[18px]">С каждым клиентом мы стараемся выстраивать взаимовыгодные и доверительные отношения.</p>}
                    text_2={<p className="text-[16px] lg:text-[18px]">Ориентируемся в своей работе на белорусские и европейские стандарты, специфику местных рынков сбыта.</p>}
                ...
                <HalfImageBlock
                    ...
                    description={
                        <p className="font-medium text-[18px] mb-[20px]">
                            Цена разработки сайтов на Джумла рассчитывается индивидуально под конкретные проекты. Итоговая стоимость будет зависеть от ряда факторов: сложности и особенностей заказа,
                            формата, структуры, количества страниц, функционала ресурса, необходимости в получении дополнительных услуг: выбор и оформление домена, размещение сайта на хостинге,
                            антивирусная защита.
                        </p>
                    }
                    buttonColor="#345CFF"

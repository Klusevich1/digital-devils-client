                        ...
                        <div className="flex flex-col">
                            <div className={`flex flex-col  justify-between lg:flex-row-reverse`}>
                                ...
                                <div className="lg:max-w-[640px]">
                                    ...
                                    <p className="font-medium text-[18px] lg:text-[20px] mb-[10px]">
                                        Воплощаем в жизнь любые дизайнерские идеи и функциональные возможности. Создаем по запросу наших клиентов блоги, интернет-магазины, электронные каталоги,
                                        одностраничные
                                        и многостраничные корпоративные порталы. Мы знаем, как сделать так, чтобы ваш сайт был привлекателен и полезен для пользователей, функционировал без сбоев и
                                        ошибок.
                                    </p>
                                </div>
                            </div>
                ...
                <BlockWithImageAndDropDownMenu
                    ...
                    data={[
                        ...
                        },
                        {
                            ...
                            description: "На базе CMS можно создавать сайты любой сложности. В системе имеется множество расширений, которые позволяет масштабировать и изменять уже функционирующий\t ресурс по мере развития бизнеса. "
                        },
                        {

          ...
          text2={
            <ul className="flex flex-col gap-[5px]">
              {[
                ...
                " Уникальный дизайн. Никаких шаблонов. Только эксклюзивные и узнаваемые решения, благодаря которым посетители запомнят именно ваш сайт.",
        ...
        <StagesOfWorkBlock
          ...
          data={[
            ...
            },
            {
              ...
              text: "Перед запуском сайта выполняем настройку его административной части. Проверяем площадку на возможные ошибки. Готовим ресурс для дальнейшей оптимизации и продвижения.",
              circles: 6,
            },
          ]}

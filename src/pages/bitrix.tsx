  ...
  return (
    <>
      <SEO
        ...
        description="Разрабатываем современные интернет-магазины на 1С-Битрикс, которые выделяют ваш бизнес среди конкурентов. Стильный дизайн, передовые технологии и адаптивность — ваши посетители оценят. Доверяйте создание своего сайта на 1С-Битрикс экспертам и получите проект, который работает на ваш успех!"
        ...
        <HalfImageBlock
          ...
          description={
            <p className="font-medium text-[18px] mb-[20px]">
              ...
              структуры до размещения на хостинге готового проекта на 1C Битрикс и выставления
              основных настроек для <a href="/seo">SEO продвижения</a> и привлечения заявок.
            </p>
          }
          buttonColor="#00BAFF"

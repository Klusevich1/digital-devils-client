      ...
      <BasicLayoutDark>
        ...
        <DifferentTasksBlock
          ...
          paragraphs={[
            {
              title: "",
              text: "Более 80% интернет-пользователей предпочитают выходить в сеть с носимых гаджетов.",
            },
            {
              title: "",
              text: "Количество клиентов, совершающих покупки в мире не со стационарного компьютера, а со смартфона или планшета растет с каждым годом.",
            },
            {
              title: "",
              text: "Количество заказов с мобильных версий сайтов только за прошлый год выросло на 70%.",
            },
          ]}
          isDark={true}
        />

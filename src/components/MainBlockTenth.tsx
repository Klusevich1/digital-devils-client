            ...
            description:
                <>
                    ...
                    <ul className="text-[18px]">
                        ...
                        <li>- SEO - специалист отвечает за оптимизацию, текстовое наполнение, подбор ключей и запросов, продвижение ресурса</li>
                        <li>- Frontend-разработчики создают пользовательские интерфейсы</li>
                        <li>- Backend-разработчики занимаются настройкой функциональной части</li>
                        <li>- UX/UI дизайнеры отвечают за удобство пользования интерфейсом и визуальную привлекательность</li>
                    </ul>
                </>,
        },
        {

      ...
      children={
        <div className="flex flex-col w-full">
          ...
          <div className="flex lg:flex-row flex-col justify-between">
            ...
            <div className="flex flex-col max-w-full lg:max-w-[414px] w-full lg:mt-0 mt-[30px] bg-blue_main rounded-[40px] text-white lg:me-[20px]">

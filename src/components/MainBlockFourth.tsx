...
const MainBlockFourth: React.FC = () => {
  return (
    <StandardMarginsLayout
      styles="text-white bg-black sm:py-[60px] py-[50px] my-[50px] sm:my-[60px]"
      children={
        <>
          <h2 className="font-bold text-[32px] md:text-[42px] lg:text-[60px] mb-[20px]">
            Хотите заказать разработку сайта под ключ?
          </h2>
          <p className="text-[18px] max-w-[764px] md:text-[24px] mb-[20px]">
            Вас бесплатно проконсультирует web-разработчик со стажем работы 5
            лет
          </p>
          <a
            className="order-3 flex transition-all md:m-0 mt-[20px]"
            href="/application"
            rel="nofollow"
          >

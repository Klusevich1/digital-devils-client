...
const Tabs: React.FC<TabsProps> = ({ arr, title }) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className='flex flex-col gap-[40px] w-[95%]'>
                ...
                <p className='text-[24px] font-medium'>Каждую задачу мы решаем с вниманием к деталям, прозрачностью процессов и стремлением превзойти ожидания. Независимо от сложности проекта, мы используем передовые технологии и креативный подход, чтобы создавать решения, которые работают и вдохновляют.</p>
            </div>

...
const MainBlockThird: React.FC = () => {
  const items = [
    ...
    },
    {
      ...
      title: "CMS",
      description:
        "Web-сайты на популярных платформах, для частных лиц и крупных компаний. Создаем уникальные решения: интернет-магазины, корпоративные порталы, блоги, информационные ресурсы, которые делают бизнес прибыльным и эффективным. Удобный интерфейс, минимальные затраты, гибкие настройки и прозрачные условия работы позволяют быстро запустить проект и легко масштабировать его по мере роста потребностей.",
      badges: [

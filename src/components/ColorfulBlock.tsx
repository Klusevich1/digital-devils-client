...
const ColorfulBlock: React.FC<ColorfulBlockProps> = ({
  ...
  return (
    <>
      <article
        className="py-[50px] md:py-[60px] text-white"
            ...
            <div className="flex flex-col lg:max-w-[641px]">
              ...
              >
                <div className="flex flex-col w-full sm:max-w-[300px] mb-[10px] sm:m-0">
                  <div
                    className={`items-center size-[28px] rounded-full justify-center mb-[15px] ${
                      titleCircleBgColor_1 == "none" ? "hidden" : "flex"
                    }`}
                  ...
                  >
                    <Image
                      src={
                        isNotDark_1
                          ? "/resources/direct-up_white.svg"
                          : "/resources/direct-up.svg"
                      }
                      alt="circle"
                      width={12.5}
                      height={12.5}
